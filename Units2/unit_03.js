...
function f4() {
   let inp1 = +document.querySelector('.i-4').value
...
function f5() {
   let inp1 = +document.querySelector('.i-5').value
...
function f6() {
   let inp1 = +document.querySelector('.i-6').value
...
function f9() {
   ...
   else if (inp1 >= 33 && inp1 <= 44) {
      out.innerHTML = '2'

   }
   else if (inp1 >= 45 && inp1 <= 60) {
      out.innerHTML = '3'
