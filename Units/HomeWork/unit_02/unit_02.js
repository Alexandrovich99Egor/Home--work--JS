...
function t13() {
    let inp13 = +document.querySelector('.i-13-1').value
    let inp14 = +document.querySelector('.i-13-2').value
...
function t16() {
    let inp16 = document.querySelector('.i-16-1').value
    let inp17 = document.querySelector('.i-16-2').value
    let out = document.querySelector(".out-16");
    let sum = parseInt(inp16) + parseInt(inp17)
...
function t17() {
    ...
    document.querySelector('.out-17-2').innerHTML = parseInt(a, 2);
...
function t18() {
    let inp1 = document.querySelector('.i-18').value
    let out = document.querySelector('.out-18')

    out.innerHTML = parseFloat(inp1)
